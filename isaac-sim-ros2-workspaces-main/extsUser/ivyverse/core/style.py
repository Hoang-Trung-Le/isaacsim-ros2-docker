...
icon_path = carb.tokens.get_tokens_interface().resolve(
    "${omni.ai.langchain.widget.core}/icons"
)
font_path = carb.tokens.get_tokens_interface().resolve(
    "${omni.ai.langchain.widget.core}/data/fonts"
)
...
chat_window_style = {
    ...
    "Button.Image::show-systems": {
        "image_url": f"{icon_path}/show-systems.svg",
