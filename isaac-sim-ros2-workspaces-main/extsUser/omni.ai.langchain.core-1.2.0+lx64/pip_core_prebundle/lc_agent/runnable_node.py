...
class RunnableNode(RunnableSerializable[Input, Output], UUIDMixin):
    ...
    def _iter(self, *args, **kwargs):
        ...
        # Save the type
        yield "__type__", self.__class__.__name__
    ...
    def _reorder_tool_messages(self, messages):
        ...
        for idx, msg in enumerate(messages):
            if isinstance(msg, AINodeMessage):
        ...
        for ainode_idx in ainode_messages_with_tool_calls:
            ...
            for tool_id in tool_ids:
                ...
                if tool_msg_idx is not None:
                    ...
                    # Missing ToolMessage, skip this AINodeMessage
                    valid_group = False
                    break
            if valid_group:
        ...
        for idx, msg in enumerate(messages):
            if isinstance(msg, AINodeMessage) and idx in ainode_idx_to_tool_ids and idx not in messages_in_groups:
