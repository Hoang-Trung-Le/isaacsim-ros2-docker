...
class PCG64(numpy.random.bit_generator.BitGenerator):
    ...
    **Compatibility Guarantee**
    ...
    state: getset_descriptor # value = <attribute 'state' of 'numpy.random._pcg64.PCG64' objects>
    pass
class PCG64DXSM(numpy.random.bit_generator.BitGenerator):
    ...
    **Compatibility Guarantee**
    ...
    def jumped(*args, **kwargs) -> typing.Any: 
        ...
        """
    __pyx_vtable__: typing.Any  # PyCapsule()
    state: getset_descriptor # value = <attribute 'state' of 'numpy.random._pcg64.PCG64DXSM' objects>
    pass
__all__ = ['PCG64']
__test__ = {}
np = numpy
