...
from pxr import Ar, Gf, Kind, Pcp, Sdf, Tf, Usd, UsdGeom, UsdLux, UsdPhysics, UsdShade, UsdSkel, UsdUtils, Vt
from pxr.Usd import CollectionAPI
...
def add_to_collection(collection_api: CollectionAPI, prim_path: str) -> bool:
